...
using NewLearning_V0._1_.Models;
...
namespace NewLearning_V0._1_.Controllers
{
    public class HomeworkController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HomeworkId,HomeworkText")] Homework homework)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HomeworkId,HomeworkText")] Homework homework)
        {
            if (ModelState.IsValid)
            {
